...
from GraphEmbedding_master.ge import Node2Vec
...
def evaluate_embeddings(embeddings):
    X, Y = read_node_label('../data/drug/edge.txt')
    tr_frac = 0.8
...
if __name__ == "__main__":
    ...
    model = Node2Vec(G, walk_length=5, num_walks=881, workers=1)#walk_length=10, num_walks=80,
